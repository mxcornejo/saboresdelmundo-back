...
/**
 * Servicio auxiliar que encapsula las operaciones transaccionales de inicialización
 * de datos. Al ser un bean separado, Spring puede aplicar correctamente el proxy AOP
 * para las transacciones, evitando la llamada directa vía {@code this}.
 */
@Slf4j
@Service
...
public class DataInitService {
    ...
    @Transactional
    public void initUsers(String adminPassword, String chefPassword, String userPassword) {
        ...
        log.info("Usuarios de prueba cargados.");
    }
    ...
    public void initRecipes() {
        ...
        carbonara.setDificultad(DIFICULTAD_MEDIA);
        ...
        tacos.setDificultad(DIFICULTAD_MEDIA);
        ...
        ceviche.setDificultad(DIFICULTAD_MEDIA);
        ...
        log.info("6 recetas iniciales cargadas.");
    }
}
