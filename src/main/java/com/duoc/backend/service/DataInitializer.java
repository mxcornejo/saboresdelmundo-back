...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initUsers() {
        ...
        userRepository.saveAll(List.of(
                new User(null, "admin", passwordEncoder.encode("admin123"), "ROLE_ADMIN"),
                new User(null, "chef", passwordEncoder.encode("chef123"), "ROLE_USER"),
                new User(null, "usuario", passwordEncoder.encode("usuario123"), "ROLE_USER")));
    ...
    public void initRecipes() {
        ...
        guacamole.setDescripcionCorta("Dip de palta fresca con limón, jalapeño y cilantro. Listo en 10 minutos.");
